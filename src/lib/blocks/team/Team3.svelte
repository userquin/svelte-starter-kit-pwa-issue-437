		...
		<div class="-m-4 flex flex-wrap">
			<div class="p-4 md:w-1/2 lg:w-1/4">
				<div class="flex h-full flex-col items-center text-center">
					<img alt="team" class="mb-4 h-56 w-full flex-shrink-0 rounded-lg object-cover object-center" src="https://dummyimage.com/200x200" />
					<div class="w-full">
			...
			<div class="p-4 md:w-1/2 lg:w-1/4">
				<div class="flex h-full flex-col items-center text-center">
					<img alt="team" class="mb-4 h-56 w-full flex-shrink-0 rounded-lg object-cover object-center" src="https://dummyimage.com/201x201" />
					<div class="w-full">
			...
			<div class="p-4 md:w-1/2 lg:w-1/4">
				<div class="flex h-full flex-col items-center text-center">
					<img alt="team" class="mb-4 h-56 w-full flex-shrink-0 rounded-lg object-cover object-center" src="https://dummyimage.com/202x202" />
					<div class="w-full">
			...
			<div class="p-4 md:w-1/2 lg:w-1/4">
				<div class="flex h-full flex-col items-center text-center">
					<img alt="team" class="mb-4 h-56 w-full flex-shrink-0 rounded-lg object-cover object-center" src="https://dummyimage.com/203x203" />
					<div class="w-full">
