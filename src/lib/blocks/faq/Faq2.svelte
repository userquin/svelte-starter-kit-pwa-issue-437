<div class="mx-auto px-4 py-16 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8 lg:py-20">
	...
	<div class="max-w-screen-xl sm:mx-auto">
		<div class="row-gap-8 grid grid-cols-1 gap-16 lg:grid-cols-2">
			<div class="space-y-8">
				<div>
					<p class="mb-4 text-xl font-medium"> The quick, brown fox jumps over a lazy dog? </p>
				...
				<div>
					<p class="mb-4 text-xl font-medium"> The first mate and his Skipper too will do? </p>
					<p class="text-gray-700">
				...
				<div>
					...
					<p class="text-gray-700"> A flower in my garden, a mystery in my panties. Heart attack never stopped old Big Bear. I didn't even know we were calling him Big Bear. </p>
				</div>
			</div>
			<div class="space-y-8">
				<div>
				...
				<div>
					<p class="mb-4 text-xl font-medium"> Galaxies Orion's sword globular star cluster? </p>
					<p class="text-gray-700">
				...
				<div>
					<p class="mb-4 text-xl font-medium"> When has justice ever been as simple as a rule book? </p>
					<p class="text-gray-700"> This is not about revenge. This is about justice. A lot of things can change in twelve years, Admiral. Well, that's certainly good to know. About four years. I got tired of hearing how young I looked. </p>
				</div>
			</div>
		</div>
	</div>
