<div class="mx-auto px-4 py-16 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8 lg:py-20">
	<div class="row-gap-8 grid gap-5 lg:grid-cols-2">
		<div class="flex flex-col justify-center">
			<div class="mb-6 max-w-xl">
				...
				<p class="text-base text-gray-700 md:text-lg"> Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae. explicabo. </p>
			</div>
			<a href="/dashboard" aria-label="" class="inline-flex items-center font-semibold text-deep-purple-accent-400 transition-colors duration-200 hover:text-deep-purple-800">
				Get Started
