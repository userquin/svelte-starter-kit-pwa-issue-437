	...
	<div class="container mx-auto flex flex-col items-center px-5 py-24 md:flex-row">
		...
		<div class="flex flex-col items-center text-center md:w-1/2 md:items-start md:pl-16 md:text-left lg:flex-grow lg:pl-24">
			...
			<div class="flex justify-center">
				<button class="inline-flex rounded border-0 bg-indigo-500 py-2 px-6 text-lg text-white hover:bg-indigo-600 focus:outline-none">Get started</button>
				<button class="ml-4 inline-flex rounded border-0 bg-gray-100 py-2 px-6 text-lg text-gray-700 hover:bg-gray-200 focus:outline-none dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Live demo</button>
			</div>
		</div>
	</div>
</section>
