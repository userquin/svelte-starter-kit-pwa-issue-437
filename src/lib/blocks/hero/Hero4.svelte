<div class="mb-16">
			...
			<div class="mb-10 max-w-xl sm:text-center md:mx-auto md:mb-12 lg:max-w-2xl">
				...
				<h2 class="mb-6 max-w-lg font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
					<span class="relative inline-block">
						<svg viewBox="0 0 52 24" fill="currentColor" class="absolute top-0 left-0 z-0 -mt-8 -ml-20 hidden w-32 text-gray-400 sm:block lg:-ml-28 lg:-mt-10 lg:w-32">
							<defs>
	...
	<div class="relative px-4 sm:px-0">
		...
		<div class="relative mx-auto grid divide-y overflow-hidden rounded bg-white shadow sm:max-w-screen-sm sm:grid-cols-3 sm:divide-y-0 sm:divide-x lg:max-w-screen-md">
