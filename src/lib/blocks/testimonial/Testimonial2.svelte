		...
		<div class="-m-4 flex flex-wrap">
			<div class="p-4 lg:w-1/2">
				<div class="flex h-full flex-col items-center justify-center text-center sm:flex-row sm:justify-start sm:text-left">
					<img alt="team" class="mb-4 h-48 w-48 flex-shrink-0 rounded-lg object-cover object-center sm:mb-0" src="https://dummyimage.com/200x200" />
			...
			<div class="p-4 lg:w-1/2">
				<div class="flex h-full flex-col items-center justify-center text-center sm:flex-row sm:justify-start sm:text-left">
					<img alt="team" class="mb-4 h-48 w-48 flex-shrink-0 rounded-lg object-cover object-center sm:mb-0" src="https://dummyimage.com/201x201" />
					<div class="flex-grow sm:pl-8">
			...
			<div class="p-4 lg:w-1/2">
				<div class="flex h-full flex-col items-center justify-center text-center sm:flex-row sm:justify-start sm:text-left">
					<img alt="team" class="mb-4 h-48 w-48 flex-shrink-0 rounded-lg object-cover object-center sm:mb-0" src="https://dummyimage.com/204x204" />
					<div class="flex-grow sm:pl-8">
			...
			<div class="p-4 lg:w-1/2">
				<div class="flex h-full flex-col items-center justify-center text-center sm:flex-row sm:justify-start sm:text-left">
					<img alt="team" class="mb-4 h-48 w-48 flex-shrink-0 rounded-lg object-cover object-center sm:mb-0" src="https://dummyimage.com/206x206" />
					<div class="flex-grow sm:pl-8">
