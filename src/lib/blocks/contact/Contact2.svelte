	...
	<div class="container mx-auto flex flex-wrap px-5 py-24 sm:flex-nowrap">
		...
		<div class="mt-8 flex w-full flex-col bg-white md:ml-auto md:mt-0 md:w-1/2 md:py-8 lg:w-1/3">
			...
			<div class="relative mb-4">
				...
				<input type="text" id="name" name="name" class="w-full rounded border border-gray-300 bg-white py-1 px-3 text-base leading-8 text-gray-700 outline-none transition-colors duration-200 ease-in-out focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200" />
			</div>
			<div class="relative mb-4">
