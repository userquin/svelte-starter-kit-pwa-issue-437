<section class="body-font text-gray-600 dark:text-gray-400">
	<div class="container mx-auto px-5 py-24">
		<div class="mb-20 flex w-full flex-col text-center">
			<h2 class="title-font mb-1 text-xs font-medium tracking-widest text-indigo-500 dark:text-indigo-400">FEDERATED DATA MICROSERVICES</h2>
			<h1 class="title-font text-2xl font-medium text-gray-900 dark:text-white sm:text-3xl">Combine GraphQL APIs into a unified supergraph</h1>
		</div>
		<div class="-m-4 flex flex-wrap">
			<div class="p-4 md:w-1/3">
				<div class="flex h-full flex-col rounded-lg bg-gray-100 p-8 dark:bg-gray-700 dark:bg-opacity-60">
					<div class="mb-3 flex items-center">
						<div class="mr-3 inline-flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-indigo-500 text-white">
			...
			<div class="p-4 md:w-1/3">
				<div class="flex h-full flex-col rounded-lg bg-gray-100 p-8 dark:bg-gray-700 dark:bg-opacity-60">
					<div class="mb-3 flex items-center">
						...
						<h2 class="title-font text-lg font-medium text-gray-900 dark:text-white">Make APIs consumable</h2>
					</div>
					<div class="flex-grow">
