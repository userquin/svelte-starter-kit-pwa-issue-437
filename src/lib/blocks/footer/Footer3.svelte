...
<footer class="body-font mt-auto text-gray-600 dark:bg-gray-900 dark:text-gray-400">
	<div class="container mx-auto px-5 py-24">
		<div class="order-first flex flex-wrap text-center md:text-left">
			<div class="w-full px-4 md:w-1/2 lg:w-1/4">
				<h2 class="title-font mb-3 text-sm font-medium tracking-widest text-gray-900 dark:text-white">CATEGORIES</h2>
				<nav class="mb-10 list-none">
					<li>
						<a href="{'#'}" class="text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white">First Link</a>
					</li>
					<li>
						<a href="{'#'}" class="text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white">Second Link</a>
					</li>
					<li>
						<a href="{'#'}" class="text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white">Third Link</a>
					</li>
					<li>
						<a href="{'#'}" class="text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white">Fourth Link</a>
					</li>
				</nav>
			</div>
			<div class="w-full px-4 md:w-1/2 lg:w-1/4">
			...
			<div class="w-full px-4 md:w-1/2 lg:w-1/4">
				<h2 class="title-font mb-3 text-sm font-medium tracking-widest text-gray-900 dark:text-white">SUBSCRIBE</h2>
				<div class="flex flex-wrap items-end justify-center md:flex-nowrap md:justify-start lg:flex-wrap xl:flex-nowrap">
					...
					<button class="inline-flex flex-shrink-0 rounded border-0 bg-indigo-500 py-2 px-6 text-white hover:bg-indigo-600 focus:outline-none lg:mt-2 xl:mt-0">Button</button>
				</div>
	...
	<div class="bg-gray-100 dark:bg-gray-800 dark:bg-opacity-75">
		<div class="container mx-auto flex flex-col items-center px-5 py-6 sm:flex-row">
			<a href="{'#'}" class="title-font flex items-center justify-center font-medium text-gray-900 dark:text-white md:justify-start">
				<Stack />
				<span class="ml-3 text-xl">Datablocks</span>
			</a>
			<p class="mt-4 text-sm text-gray-500 dark:text-gray-400 sm:ml-6 sm:mt-0"
				>© 2020 Datablocks —
				<a href="https://twitter.com/xmlking" class="ml-1 text-gray-600 dark:text-gray-500" rel="external">@sumanth</a>
			</p>
			<span class="mt-4 inline-flex justify-center sm:ml-auto sm:mt-0 sm:justify-start">
				...
				<a href="{'#'}" class="ml-3 text-gray-500 dark:text-gray-400">
					<svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="h-5 w-5" viewBox="0 0 24 24">
