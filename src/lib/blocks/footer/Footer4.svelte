		...
		<div class="order-first flex flex-wrap text-center md:text-left">
			<div class="w-full px-4 md:w-1/2 lg:w-1/4">
				...
				<nav class="mb-10 list-none">
					<li>
						<a class="text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white">First Link</a>
					</li>
					<li>
						<a class="text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white">Second Link</a>
					</li>
					<li>
						<a class="text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white">Third Link</a>
					</li>
					<li>
						<a class="text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white">Fourth Link</a>
					</li>
				</nav>
			</div>
			<div class="w-full px-4 md:w-1/2 lg:w-1/4">
	...
	<div class="bg-gray-100 dark:bg-gray-800 dark:bg-opacity-75">
		<div class="container mx-auto flex flex-col items-center px-5 py-6 sm:flex-row">
			...
			<p class="mt-4 text-sm text-gray-500 dark:text-gray-400 sm:ml-6 sm:mt-0"
				>© 2020 Datablocks —
				<a href="https://twitter.com/xmlking" class="ml-1 text-gray-600 dark:text-gray-500" target="_blank">@sumanth</a>
			</p>
