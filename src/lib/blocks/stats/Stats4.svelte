<div class="mx-auto px-4 py-16 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8 lg:py-20">
	<div class="row-gap-8 grid grid-cols-2 md:grid-cols-4">
		<div class="text-center md:border-r">
			...
			<p class="text-sm font-medium uppercase tracking-widest text-gray-800 lg:text-base"> Downloads </p>
		</div>
		<div class="text-center md:border-r">
			<h6 class="text-4xl font-bold lg:text-5xl xl:text-6xl">12.9K</h6>
			<p class="text-sm font-medium uppercase tracking-widest text-gray-800 lg:text-base"> Subscribers </p>
		</div>
		<div class="text-center md:border-r">
		...
		<div class="text-center">
			...
			<p class="text-sm font-medium uppercase tracking-widest text-gray-800 lg:text-base"> Cookies </p>
		</div>
	</div>
</div>
