		...
		<div class="whitespace-nowrap">
			...
			<div class="flex items-end gap-2">
				...
				<div class="mb-0.5 flex items-center gap-0.5 text-sm font-semibold text-green-500 ">
					...
					<svg class="h-3 w-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="4" d="M19 14l-7 7m0 0l-7-7m7 7V3" /></svg>
					-3.2 %
				</div>
			</div>
		</div>
