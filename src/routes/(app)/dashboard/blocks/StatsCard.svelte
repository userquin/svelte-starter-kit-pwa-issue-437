					...
					<div class="ml-5 w-0 flex-1">
						...
						<dd class="flex items-baseline">
							...
							<div class="ml-2 flex items-baseline text-sm font-semibold text-green-600">
								<svg class="h-5 w-5 flex-shrink-0 self-center text-green-500" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
					...
					<div class="ml-5 w-0 flex-1">
						...
						<dd class="flex items-baseline">
							...
							<div class="ml-2 flex items-baseline text-sm font-semibold text-red-600">
								<svg class="h-5 w-5 flex-shrink-0 self-center text-red-500" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
